...
local theme = {
  ...
  red     = { ["dark"] = "#BF616A", ["light"] = "#B74E58" },
  orange  = { ["dark"] = "#D08770", ["light"] = "#CB775D" },
  yellow  = { ["dark"] = "#EBCB8B", ["light"] = "#E7C173" },
  green   = { ["dark"] = "#A3BE8C", ["light"] = "#97B67C" },
  aqua    = { ["dark"] = "#8FBCBB", ["light"] = "#80B3B2" },
  blue    = { ["dark"] = "#5E81AC", ["light"] = "#88C0D0" },
  purple  = { ["dark"] = "#B48EAD", ["light"] = "#A97EA1" },
